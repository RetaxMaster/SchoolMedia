...
function onPageStart() {
    ...
    setTableLabels('#tablaVerTodos', LangLabelsURL, true, './ajax_calst_vals_rcvry.php?Lang=' + globalLang + '&enbd=2&UID=' + getCookie("UID") + '&USS=' + getCookie("USS") + '', function (res) {
