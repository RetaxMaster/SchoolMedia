...
function onPageStart() {
   ...
   /* setInnerAttrs(global_hintsObj["txts"], global_hintsObj["attrsx"], global_hintsObj["components_ids"]) */ // fija atributos
    ...
    setTableLabels('#tablaVerTodos', LangLabelsURL, true, './ajax_imps_consumo_rcvry.php?Lang='+globalLang+'&enbd=2&UID='+getCookie("UID")+'&USS='+getCookie("USS")+''); // Se fijan los labels estandars de las tablas y sus busquedas
