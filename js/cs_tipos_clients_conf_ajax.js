...
function onPageStart() {
    ...
    setTableLabels('#tablaVerTodos', LangLabelsURL, true, './ajax_tipos_clients_rcvry.php?Lang='+globalLang+'&UID='+getCookie("UID")+'&USS='+getCookie("USS")+''); // Se fijan los labels estandars de las tablas y sus busquedas
}
