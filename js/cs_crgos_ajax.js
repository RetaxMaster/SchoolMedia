...
function onPageStart() {
    ...
    selecDptosPopulate("#selectCtry", 0, global_default);
    setTableLabels('#tablaVerTodos', LangLabelsURL, true, './ajax_crgos_rcvry.php?Lang='+globalLang+'&UID='+getCookie("UID")+'&USS='+getCookie("USS")+''); // Se fijan los labels estandars de las tablas y sus busquedas
}
