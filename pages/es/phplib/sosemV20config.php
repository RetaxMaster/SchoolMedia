...
//$DomainName="www.esdca.net/iemm"; // Nombre y ruta del dominio donde se instala el SOSEM V2.0, directorio ra�z de SOSEM, en este caso se refiere a un subdominio
define("DOMAIN_NAME",".");//..
...
define("USR_PAGES",BASE_INSTALL_DIR . "/page");
...
// Pagina de registro de usuario $RecordPage = "http://".$DomainName."/record/".$Lang."/"; // Pagina de registro al sistema

// $ContactPage = "http://".$DomainName."/contactenos/".$Lang."/"; // Pagina de contactenos
...
// Base de datos global usda para el administrador. Recordar que sosem maneja usuarios y administradores de manera independiente,
// en DB sepradas$GlobalDB = "cimmaV1Admin";
define("GLOBAL_DB","osMEDASV1Admin");
