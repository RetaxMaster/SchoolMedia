...
function caimps_recoveryAllByAnyField(&$nDocs, &$Docs, $field, $value, $enabled, $join = false, $extraWhere = "")
{ // true or false
    $tinyint = (int) $join;
    $SQLStrQuery = "CALL sp_p_lst_caimps_byAnyField('$field', '$value', $enabled, $tinyint, '$extraWhere')";
    SQLQuery($ResponsePointer, $nDocs, $SQLStrQuery, true); // Realiza la consulta
    ConvertPointerToArray($ResponsePointer, $Docs, $nDocs, 5); // Pertenece a dbmngmtAdmin.php
}
