...
function prdcts_createRecord($cod, $descrip, $stock, $tiposp, $puvp, $id_imp, $costu, $id_pais)
{
    $SQLStrQuery = "CALL sp_p_set_caprdcts_Create('$cod', '$descrip', '$stock', '$tiposp', '$puvp', '$id_imp', '$costu', '$id_pais')";
