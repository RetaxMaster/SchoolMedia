...
// *****************************************************************
// xxxxxx "Inserta los datos de una página visitada en el Log / no debería ejecutarse ya que se dispara con un trigger"
	function LH_SetLog($iUID,$IpFrom,$NowAt){
		$SQLStrQuery="CALL LH_SetLog($iUID,'$IpFrom','$NowAt')"; // "INSERT INTO LogHistory (UID,IPFROM,TIMECONNECTED,VISITEDURL) VALUES ('".$iUID."','".$IpFrom."','".$Time."','".$NowAt."')";
