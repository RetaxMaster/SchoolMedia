...
// Se valida que el usuario que realiza la solicitud se encuentre logged y que la session siga activa
    ...
    include_once(LIBRARY_DIR."/calific.php"); // Se incluyen las funciones de control de Calificacion de cuentas
    cal_recoveryAllList($ncCuenta,$cCuentaArry); // Se recuperan todos los registros de todos los paises, activos o no
