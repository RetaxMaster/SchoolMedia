<?php
	...
	include_once(LIBRARY_DIR."/paises.php");
	...
	// dataToStr("['",$wpContentArry_Msgs,"','","']",$wpContentStr_Msgs); // se formatea la cadena para enviar a JavaScript
	pa_recoveryAllListEnabled($nCtry,$CtryLst,1); // Recupero el listado de paises que se encuentran habilitados y disponibles para operar por SchoolMedia
	pa_dropDownButtonItemTag($nCtry,$CtryLst,$CtryDataArry); // Se construyen los tags HTML para los DropDown
	include_once(USR_PAGES."/dashboard.php");
?>