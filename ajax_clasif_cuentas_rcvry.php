...
// Se valida que el usuario que realiza la solicitud se encuentre logged y que la session siga activa
    ...
    include_once(LIBRARY_DIR."/clasif_cuentas.php"); // Se incluyen las funciones de control de formatos publicitarios
    cc_recoveryAllList($ncCuenta,$cCuentaArry); // Se recuperan todos los registros de todos los paises, activos o no
    JSonformatedData($ncCuenta,$cCuentaArry,$JSonDataObj); // Se hace el formato de Cadena embebido JSon para ser enviado. Pertenece a Shared
